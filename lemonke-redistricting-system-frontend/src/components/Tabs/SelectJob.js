...
function SelectJob() {
    ...
    const [selectedIndex, setSelectedIndex] = React.useState([0,"# of Districtings: 100,243 -> 1,096. (More info about job 1)"]);
    ...
    return (
        <>
            ...
            <List component = "nav" aria-labe="job lists">
                ...
                onClick={(event) => handleSelectedList(event, 0, "# of Districtings: 100,243 -> 1,096. (More info about job 1)")}>
                    <ListItemText primary="Job 1" secondary="New York, 27 districtings, (Some MGGG code param)">
                    </ListItemText>
                </ListItem>
                <ListItem button
                selected={selectedIndex[0] === 1} 
                onClick={(event) => handleSelectedList(event, 1, "# of Districtings: 101,632 -> 987. (More info about job 2)")}>
                ...
                onClick={(event) => handleSelectedList(event, 2, "# of Districtings: 99,874 -> 1,234. (More info about job 3)")}>
